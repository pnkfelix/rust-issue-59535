...
#[cfg(not_now)] impl super::TASKS_TRIGGER {
...
pub enum TASKS_TRIGGERW {
    #[doc = "Trigger task"]
    TRIGGER,
}
impl TASKS_TRIGGERW { }
#[cfg(not_now)] impl TASKS_TRIGGERW {
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _bits(&self) -> bool {
        match *self {
            TASKS_TRIGGERW::TRIGGER => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _TASKS_TRIGGERW<'a> { }
#[cfg(not_now)]
impl<'a> _TASKS_TRIGGERW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: TASKS_TRIGGERW) -> &'a mut W {
        {
    ...
    pub fn trigger(self) -> &'a mut W {
        self.variant(TASKS_TRIGGERW::TRIGGER)
    }
