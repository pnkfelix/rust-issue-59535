...
#[cfg(not_now)] impl EVENTS_ENDR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            EVENTS_ENDR::NOTGENERATED => false,
            EVENTS_ENDR::GENERATED => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> EVENTS_ENDR {
        match value {
            false => EVENTS_ENDR::NOTGENERATED,
            true => EVENTS_ENDR::GENERATED,
        }
    }
    #[doc = "Checks if the value of the field is `NOTGENERATED`"]
    #[inline]
    pub fn is_not_generated(&self) -> bool {
        *self == EVENTS_ENDR::NOTGENERATED
    }
    #[doc = "Checks if the value of the field is `GENERATED`"]
    #[inline]
    pub fn is_generated(&self) -> bool {
        *self == EVENTS_ENDR::GENERATED
    }
}
...
#[cfg(not_now)] impl EVENTS_ENDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            EVENTS_ENDW::NOTGENERATED => false,
            EVENTS_ENDW::GENERATED => true,
        }
    }
}
#[doc = r" Proxy"]
...
#[cfg(not_now)] impl<'a> _EVENTS_ENDW<'a> {
    ...
    pub fn not_generated(self) -> &'a mut W {
        self.variant(EVENTS_ENDW::NOTGENERATED)
    }
    #[doc = "Event generated"]
    #[inline]
    pub fn generated(self) -> &'a mut W {
        self.variant(EVENTS_ENDW::GENERATED)
    }
...
#[cfg(not_now)] impl R {
    ...
    #[inline]
    pub fn events_end(&self) -> EVENTS_ENDR {
        EVENTS_ENDR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 0;
...
#[cfg(not_now)] impl W {
    ...
    #[doc = "Bit 0 - Granted transaction completed"]
    #[inline]
    pub fn events_end(&mut self) -> _EVENTS_ENDW {
        _EVENTS_ENDW { w: self }
    }
}
