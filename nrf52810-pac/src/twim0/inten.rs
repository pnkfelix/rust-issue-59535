...
#[cfg(not_now)] impl SUSPENDEDW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            SUSPENDEDW::DISABLED => false,
            SUSPENDEDW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
#[cfg(not_now)] impl<'a> _SUSPENDEDW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(SUSPENDEDW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(SUSPENDEDW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[cfg(not_now)] impl LASTRXW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            LASTRXW::DISABLED => false,
            LASTRXW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
#[cfg(not_now)] impl<'a> _LASTRXW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(LASTRXW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(LASTRXW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[cfg(not_now)] impl LASTTXW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            LASTTXW::DISABLED => false,
            LASTTXW::ENABLED => true,
        }
    }
}
#[doc = r" Proxy"]
...
#[cfg(not_now)] impl<'a> _LASTTXW<'a> {
    ...
    #[inline]
    pub fn disabled(self) -> &'a mut W {
        self.variant(LASTTXW::DISABLED)
    }
    #[doc = "Enable"]
    #[inline]
    pub fn enabled(self) -> &'a mut W {
        self.variant(LASTTXW::ENABLED)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
